...
import { Copy, ExternalLink, Info, Clock, Table2 } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-500/10 border border-blue-500/20 p-4 rounded-lg flex gap-3 items-center">
        ...
        <p className="text-[13px] text-blue-700/80 leading-relaxed">
          <strong>Your setup:</strong> Make.com + Gmail + Google Drive + Claude API all available.
          These automations use your existing subscriptions — no extra cost.
        </p>
      </div>
